  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.hero}> 
        ...
        <Text style={styles.subtitle}>Gerencie instâncias independentes em Android e iOS sem misturar dados.</Text>
      </View>

      <ScrollView contentContainerStyle={styles.list}>
        {tenants.map((tenant) => (
          <TouchableOpacity key={tenant.id} style={styles.card} onPress={() => setSelectedTenant(tenant)}>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#ffffff', borderRadius: 24, padding: 22, marginBottom: 16, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 16, shadowOffset: { width: 0, height: 10 }, elevation: 2 },
  badge: { alignSelf: 'flex-start', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6, marginBottom: 16 },
